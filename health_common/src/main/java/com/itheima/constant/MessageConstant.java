...
public class MessageConstant {
    ...
    //xgw_新增用户结果
    public static final String ADD_UserMember_SUCCESS = "新增用户成功";
    public static final String ADD_UserMember_FALL = "新增用户失败";
    //xgw_新增用户结果
    public static final String QUERY_Role_SUCCESS = "查询角色成功";
    public static final String QUERY_Role_FALL = "查询角色失败";
    //xgw_新增用户角色结果
    public static final String ADD_Role_SUCCESS = "新增用户角色成功";
    public static final String ADD_Role_FALL = "新增用户角色失败";
}
